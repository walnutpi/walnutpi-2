# What it does: Detects faces in a live USB camera stream with a Haar cascade classifier
# Wiring:       Connect a USB camera to a USB port
# Expected output: The live video is shown with every detected face boxed in red and the FPS
