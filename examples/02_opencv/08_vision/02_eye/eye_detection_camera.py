# What it does: Detects eyes in a live USB camera stream with a Haar cascade classifier
# Wiring:       Connect a USB camera to a USB port
# Expected output: The live video is shown with every detected eye boxed in red and the FPS
